...
class TestContactAdd(unittest.TestCase):
    ...
    def create_contact(self, wd, firstname, middlename, lastname, nickname, title, company, address, home, mobile, work,
                       fax, email1, email2, email3, homepage, bday, bmonth, byear, aday, amonth, ayear, address2, notes,
                       phone2):
    ...
    def test_contact_add(self):
        ...
        self.login(wd)
        self.create_contact(wd, firstname="Homer", middlename="Jay", lastname="Simpson", nickname="Hommy", title="Some",
